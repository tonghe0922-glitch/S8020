...
const hiddenPageTitleRoutes=new Set(['org-directory-architecture','org-architecture-tech'])
const showPageTitle=computed(()=>!hiddenPageTitleRoutes.has(String(route.name??'')))
