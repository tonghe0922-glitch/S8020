-- PHASE-03 tenant RLS + database-connect security overlay for sjg_dw.
REVOKE CONNECT, TEMPORARY ON DATABASE sjg_dw FROM PUBLIC;
GRANT CONNECT, CREATE, TEMPORARY ON DATABASE sjg_dw TO sjg_owner;
GRANT CONNECT ON DATABASE sjg_dw TO sjg_migration, sjg_dw_writer, sjg_dw_reader;
