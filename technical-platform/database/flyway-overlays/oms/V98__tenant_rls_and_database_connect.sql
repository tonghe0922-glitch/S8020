-- PHASE-03 tenant RLS + database-connect security overlay for sjg_oms.
REVOKE CONNECT, TEMPORARY ON DATABASE sjg_oms FROM PUBLIC;
GRANT CONNECT, CREATE, TEMPORARY ON DATABASE sjg_oms TO sjg_owner;
GRANT CONNECT ON DATABASE sjg_oms TO sjg_migration, sjg_api_runtime, sjg_worker_runtime;
