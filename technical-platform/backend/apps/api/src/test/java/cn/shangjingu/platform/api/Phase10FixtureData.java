...
final class Phase10FixtureData {
    static final UUID TENANT =
            UUID.fromString("00000000-0000-0000-0000-000000001010");
    static final UUID CENTER_A =
            UUID.fromString("10000000-0000-0000-0000-000000001010");
    static final UUID CENTER_B =
            UUID.fromString("10000000-0000-0000-0000-000000001011");
    static final UUID POSITION_A =
            UUID.fromString("20000000-0000-0000-0000-000000001010");
    static final UUID POSITION_B =
            UUID.fromString("20000000-0000-0000-0000-000000001011");

    static final UUID EMPLOYEE =
            UUID.fromString("30000000-0000-0000-0000-000000001010");
    static final UUID MANAGER =
            UUID.fromString("30000000-0000-0000-0000-000000001011");
    static final UUID TECH =
            UUID.fromString("30000000-0000-0000-0000-000000001012");
    static final UUID OUT =
            UUID.fromString("30000000-0000-0000-0000-000000001013");

    static final UUID EMPLOYEE_APPOINTMENT =
            UUID.fromString("40000000-0000-0000-0000-000000001010");
    static final UUID MANAGER_APPOINTMENT =
            UUID.fromString("40000000-0000-0000-0000-000000001011");
    static final UUID TECH_APPOINTMENT =
            UUID.fromString("40000000-0000-0000-0000-000000001012");
    static final UUID OUT_APPOINTMENT =
            UUID.fromString("40000000-0000-0000-0000-000000001013");

    static final UUID EMPLOYEE_USER =
            UUID.fromString("50000000-0000-0000-0000-000000001010");
    static final UUID MANAGER_USER =
            UUID.fromString("50000000-0000-0000-0000-000000001011");
    static final UUID TECH_USER =
            UUID.fromString("50000000-0000-0000-0000-000000001012");
    static final UUID OUT_USER =
            UUID.fromString("50000000-0000-0000-0000-000000001013");

    static final UUID EMPLOYEE_IDENTITY =
            UUID.fromString("60000000-0000-0000-0000-000000001010");
    static final UUID MANAGER_IDENTITY =
            UUID.fromString("60000000-0000-0000-0000-000000001011");
    static final UUID TECH_IDENTITY =
            UUID.fromString("60000000-0000-0000-0000-000000001012");
    static final UUID OUT_IDENTITY =
            UUID.fromString("60000000-0000-0000-0000-000000001013");

    static final UUID EMPLOYEE_ROLE =
            UUID.fromString("70000000-0000-0000-0000-000000001010");
    static final UUID MANAGER_ROLE =
            UUID.fromString("70000000-0000-0000-0000-000000001011");
    static final UUID TECH_ROLE =
            UUID.fromString("70000000-0000-0000-0000-000000001012");
    static final UUID OUT_ROLE =
            UUID.fromString("70000000-0000-0000-0000-000000001013");
    static final UUID QUALIFICATION_ROLE =
            UUID.fromString("70000000-0000-0000-0000-000000001014");
    ...
    private static void seedOrganization(Statement statement) throws Exception {
        statement.execute("INSERT INTO org.organization(id,tenant_id,org_code,org_name,org_type,path,status) VALUES "
                + "('" + CENTER_A + "','" + TENANT + "','P10_CENTER_A','PHASE10 Center A','CENTER','p10_center_a'::ltree,'ACTIVE'),"
                + "('" + CENTER_B + "','" + TENANT + "','P10_CENTER_B','PHASE10 Center B','CENTER','p10_center_b'::ltree,'ACTIVE')");
        statement.execute("INSERT INTO org.position(id,tenant_id,position_code,position_name,org_id,status) VALUES "
                + "('" + POSITION_A + "','" + TENANT + "','P10_POS_A','PHASE10 Position A','" + CENTER_A + "','ACTIVE'),"
                + "('" + POSITION_B + "','" + TENANT + "','P10_POS_B','PHASE10 Position B','" + CENTER_B + "','ACTIVE')");
    }
    ...
    private static void seedAuthorization(Statement statement) throws Exception {
        ...
        grant(statement, EMPLOYEE_ROLE,
                "platform.session.read", "platform.session.logout",
                "p006.meeting.read", "p006.meeting.action",
                "p007.schedule.read", "p007.schedule.change",
                "p008.leave.submit", "p008.leave.read",
                "p009.overtime.submit", "p009.overtime.read",
                "p010.learning.read", "p010.learning.complete", "p010.learning.exam");
        String[] managerPermissions = {
            "platform.session.read", "platform.session.logout",
            "p006.meeting.create", "p006.meeting.read", "p006.meeting.manage", "p006.meeting.accept",
            "p007.schedule.read", "p007.schedule.manage", "p007.schedule.change", "p007.schedule.review",
            "p008.leave.read", "p008.leave.review", "p008.leave.manage",
            "p009.overtime.read", "p009.overtime.review", "p009.overtime.hr", "p009.overtime.manage",
            "p010.learning.read", "p010.learning.manage", "p010.learning.certify"
        };
        grant(statement, MANAGER_ROLE, managerPermissions);
        grant(statement, OUT_ROLE, managerPermissions);
        grant(statement, TECH_ROLE,
                "platform.session.read", "platform.session.logout",
                "p006.meeting.monitor", "p007.schedule.monitor", "p008.leave.monitor",
                "p009.overtime.monitor", "p010.learning.monitor");
    ...
    private static void grant(Statement statement, UUID roleId, String... permissionCodes)
            throws Exception {
