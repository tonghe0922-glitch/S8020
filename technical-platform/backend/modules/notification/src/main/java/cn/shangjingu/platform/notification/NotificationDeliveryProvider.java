...
public interface NotificationDeliveryProvider {
    ...
    record DeliveryRequest(UUID tenantId, UUID messageId, String recipientType, UUID recipientId,
                           String channel, String title, String body, String idempotencyKey) {}
