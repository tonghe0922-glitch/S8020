    ...
    try (PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>(POSTGRES_IMAGE)
      ...
      for (Map.Entry<String, String> entry : Map.of(
        ...
        Flyway flyway = Flyway.configure()
            ...
            .locations(
                "filesystem:" + root.resolve("technical-platform/database/flyway").resolve(entry.getValue()),
                "filesystem:" + root.resolve("technical-platform/database/flyway-overlays").resolve(entry.getValue()))
            .placeholders(Map.of(
