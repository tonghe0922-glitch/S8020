...
public class JdbcOrgDirectoryAdapter implements OrgDirectoryPort {
    ...
    private static EmployeeRecord employee(ResultSet rs) throws SQLException {
        return new EmployeeRecord(
                ...
                rs.getObject("leave_date", java.time.LocalDate.class),
                rs.getObject("primary_org_id", UUID.class),
                rs.getObject("primary_position_id", UUID.class));
    }
    ...
    private static AppointmentRecord appointment(ResultSet rs) throws SQLException {
        return new AppointmentRecord(
                ...
                rs.getObject("effective_start_date", java.time.LocalDate.class),
                rs.getObject("effective_end_date", java.time.LocalDate.class),
                rs.getString("status"));
    }
}
